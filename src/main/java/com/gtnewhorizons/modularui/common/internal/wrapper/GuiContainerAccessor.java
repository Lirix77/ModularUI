...
public abstract class GuiContainerAccessor extends GuiContainer {
    ...
    static {
        ...
        try {
            ...
            fieldIsRightMouseClick = isDevEnv ? gc.getDeclaredField("isRightMouseClick")
                    : gc.getDeclaredField("field_147004_w");
            ...
            fieldReturningStack = isDevEnv ? gc.getDeclaredField("returningStack")
                    : gc.getDeclaredField("field_146991_C");
            fieldReturningStack.setAccessible(true);
            fieldReturningStackDestSlot = isDevEnv ? gc.getDeclaredField("returningStackDestSlot")
                    : gc.getDeclaredField("field_146989_A");
            ...
            fieldReturningStackTime = isDevEnv ? gc.getDeclaredField("returningStackTime")
                    : gc.getDeclaredField("field_146990_B");
